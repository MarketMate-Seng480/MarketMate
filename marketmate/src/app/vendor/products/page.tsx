...
export default function VendorProductPage() {
  ...
  const [products, setProduct] = useState<Product[]>([
    {name: "Pink Chair", description: "A beautiful pink chair that is perfect for your living room.", price: 100, image: 'https://images.unsplash.com/photo-1518051870910-a46e30d9db16?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1350&q=80', vendorId: 0},
    {name: "Pink Chair", description: "A beautiful pink chair that is perfect for your living room.", price: 100, image: 'https://images.unsplash.com/photo-1518051870910-a46e30d9db16?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1350&q=80', vendorId: 0},
  ]);
